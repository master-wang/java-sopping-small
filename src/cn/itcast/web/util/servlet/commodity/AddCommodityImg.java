...
@WebServlet("/addCommodityImg")
public class AddCommodityImg extends HttpServlet {
    @Override
        ...
        for (FileItem item:fileItems) {
            ...
            if (item.isFormField()){
                ...
                try {
                    ...
                    String[] arr = ph.split("shopping_small_war_exploded");
                    String tou = "http://localhost:8080/shopping_small_war_exploded";
                    String b = tou+arr[1];
                    System.out.println(arr[1]);
                    System.out.println(b);

                    CommodityDao dao = new CommodityDaoimpl();
                    int count = dao.updatePetHeadimgById(c_id, b);
                    //删除零食文件
                    item.delete();
